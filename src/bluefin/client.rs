...
// custom modules
use crate::bluefin::orders::{create_market_order, get_serialized_order, to_order_request, Order};
...
impl ClientMethods for BluefinClient {
    ...
    async fn onboard(&mut self) {
        ...
        let onboarding_sig = format!("{}1", onboarding_sig_temp.to_string().to_ascii_lowercase());
...
fn should_create_wallet() {
    let wallet = create_wallet("c501312ca9eb1aaac6344edbe160e41d3d8d79570e6440f2a84f7d9abf462270");
    assert_eq!(
        wallet.address,
