...
pub struct TradeOrder {
    pub trade: TradeOrderUpdate,
}

#[derive(Deserialize, Debug)]
pub struct TradeOrderMessage {
    pub data: Option<TradeOrder>,
    pub error: Option<Error>
}
...
#[derive(Deserialize, Debug)]
pub struct OrderSettlementUpdateMessage {
    pub data: Option<OrderSettlementUpdate>,
    pub error: Option<Error>,
}
...
pub struct OrderSettlementUpdate {
    ...
    #[serde(deserialize_with = "deserialize_to_f64_via_decimal")]
    pub quantity_sent_for_settlement: f64,
    pub symbol: String,
    pub timestamp: u128,
    pub is_maker: bool,
    pub is_buy: bool,
...
#[derive(Deserialize, Debug)]
pub struct OrderSettlementCancellationMessage {
    pub data: Option<OrderSettlementCancellation>,
    pub error: Option<Error>
}
...
pub struct OrderSettlementCancellation {
    ...
    pub is_buy: bool,
    #[serde(deserialize_with = "deserialize_to_f64_via_decimal")]
    pub quantity_sent_for_cancellation: f64,
    pub fill_id: String,
    pub timestamp: u128,
}
